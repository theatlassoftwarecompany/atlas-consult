...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* AI Compliance Funnel — static image */}
      <section className="py-24 sm:py-32" style={{ backgroundColor: '#2c2c2c' }}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="zoom-in text-center mb-16">
            <h2 className="text-base font-semibold leading-7 text-accent">How Arbitor Works</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              The AI Compliance Funnel
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-400 max-w-2xl mx-auto">
              Every query passes through five intelligent layers — ensuring answers are grounded, trusted, and continuously improving.
            </p>
          </div>
          <div className="w-full">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/compliance-funnel.png"
              alt="AI Compliance Funnel"
